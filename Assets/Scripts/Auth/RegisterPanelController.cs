...
//{
//    [Header("Register UI")]
//    public TMP_InputField usernameInput;     // ник / имя пользователя
//    public TMP_InputField realNameInput;     // настоящее имя
//    public TMP_InputField passwordInput;     // пароль
//    public TMP_InputField confirmInput;      // подтверждение пароля
//    public TextMeshProUGUI statusText;       // статус/ошибки
//    public Button registerButton;            // кнопка "Зарегистрироваться"
...
//        if (p1.Length < 6) { SetStatus("Пароль ≥ 6 символов"); return; }
//        if (p1 != p2) { SetStatus("Пароли не совпадают"); return; }

//        SetStatus("Регистрация...");
//        var (ok, err) = await AuthManager.Instance.Register(u, r, p1);
//        if (!ok) { SetStatus("Ошибка: " + err); return; }

//        // успех → открыть приложение
...
//        if (icon)
//            icon.sprite = visible ? eyeOpen : eyeClosed;
//    }
//}
